...
public class G02GenericsMetotlar {
    ...
    // - Generic veri tipleri sadece non-primitif olabilir. Binary operatörler (+, -,*, / ,<, >) ise non-primitif
    //   veri tiplerinde kullanılamazlar. Dolayısıyla bir generic metotta karşılaştırma için ne kullanılabilir?
